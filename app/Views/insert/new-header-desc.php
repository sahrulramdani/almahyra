...
<div class="main-content">
    <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Forms/</span> Tambah Header Desc</h4>

    <form action="/dashboard/header-desc/save" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="subjudul" name="subjudul"
                        placeholder="Apa yang kami tawarkan ?" required />
                </div>
            </div>
