...
<div class="main-content">
    ...
    <div class="row">
        <div class="col-lg-6"><img src="/images/layouts/pembimbing-desc.png" alt="" class="introduction-img"></div>
    </div>
            ...
            <div class="card">
                <div class="card-header row align-items-center">
                    <div class="col-lg-3 mb-1">
                        <h5 class="header-title m-auto d-block">List Pembimbing</h5>
                    </div>
                    <div class="col-lg-9 mb-1">
                        <a href="/dashboard/pembimbing/new" class="btn btn-primary button-tambah">Tambah </a>
                    </div>
                </div>
                    ...
                    <table class="table" id="testimoni">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="action">
                                    <a href="/dashboard/pembimbing/edit/<?= $lp['id_pembimbing']; ?>"><i
                                            class='bx bx-edit-alt'></i></a>
                                    <a href="/dashboard/pembimbing/delete/<?= $lp['id_pembimbing']; ?>"
