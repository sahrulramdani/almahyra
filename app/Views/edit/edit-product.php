...
<div class="main-content">
    <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Forms/</span> Edit Produk</h4>

    <form action="/dashboard/product/update" method="post" enctype="multipart/form-data">
        ...
        <div class="card p-3">
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="nama_produk" name="nama_produk"
                        placeholder="Umroh / Haji Murah" required value="<?= $dataProduk['nama_produk']; ?>" />
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-4">
                    <select id="jenis_select" class="form-select" name="jenis_produk" id="jenis_produk">
                        <option value="1" <?= $dataProduk['jenis_produk'] == '1' ? 'selected' : '' ?>>Umroh </option>
                        <option value="2" <?= $dataProduk['jenis_produk'] == '2' ? 'selected' : '' ?>>Haji </option>
                    </select>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-2">
                    <input class="form-control" type="date" id="tanggal_berangkat" name="tanggal_berangkat"
                        value="<?php echo $dataProduk['tanggal_berangkat']; ?>" />
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-2">
                    <input class="form-control" type="date" id="tanggal_pulang" name="tanggal_pulang"
                        value="<?php echo $dataProduk['tanggal_pulang']; ?>" />
                </div>
            </div>

            <div class="row mb-1">
                <div class="col-sm-2"></div>
                <div class="col-sm-10"><img src="/images/upload/<?= $dataProduk['foto']; ?>" alt="" class="imgPreview"
                        style="width: 35%;">
                </div>
            </div>

            <input type="hidden" value="<?= $dataProduk['foto']; ?>" id="fotoLama" name="fotoLama">
            <input type="hidden" value="<?= $dataProduk['id_produk']; ?>" id="idProduk" name="idProduk">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-4">
                    <select id="jenis_select" class="form-select" name="nama_pembimbing" id="nama_pembimbing">
                        ...
                        <option value="<?= $lp['id_pembimbing']; ?>"
                            <?= $dataProduk['pembimbing'] == $lp['id_pembimbing'] ? 'selected' : '' ?>>
                            <?= $lp['nama_pembimbing']; ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea id="catatan" name="catatan" class="form-control" rows="4" cols="50"
                        required><?= $dataProduk['catatan']; ?></textarea>
                </div>
            </div>
        </div>
    </form>
