...
<div class="main-content">
    <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Forms/</span> Edit Testimoni</h4>

    <form action="/dashboard/testimoni/update" method="post" enctype="multipart/form-data">
        ...
        <div class="card p-3">
            <input type="hidden" value="<?= $dataTestimoni['foto']; ?>" id="fotoLama" name="fotoLama">
            <input type="hidden" value="<?= $dataTestimoni['id_testimoni']; ?>" id="idTestimoni" name="idTestimoni">

            <div class="row mb-1">
                <div class="col-sm-2"></div>
                <div class="col-sm-10"><img src="/images/upload/<?= $dataTestimoni['foto']; ?>" alt=""
                        class="imgPreview" style="width: 35%;">
                </div>
            </div>
